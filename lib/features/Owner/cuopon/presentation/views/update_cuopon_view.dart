                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: AppTextFormField(
                            controller:
                                context.read<UpdateCuponCubit>().cuponName,
                        ...
                        //               .w600), // غيّريها حسب الـ style المناسب لكِ
                        //     ),
                        //     8.vs,
                        //     Row(
                        //       children: [
                        ...
                        SizedBox(
                          ...
                          child: AppTextFormField(
                            controller:
                                context.read<UpdateCuponCubit>().discount,
                            floatingLabelBehavior: FloatingLabelBehavior.always,
                            hintText: "20.0",
                            labelText: "discount",
                            validator: (p0) {},
                        ...
                        Padding(
                          ...
                          child: AppTextButton(
                            ...
                            text: context.read<UpdateCuponCubit>().state
                                    is UpdateCuponLoadingState
                                ? "Save....."
                                : "Save",
                            onPressed: () {
                              context
                                  .read<UpdateCuponCubit>()
