...
class _CouponsSource implements CouponsSource {
  _CouponsSource(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<dynamic> createCoupon(CuponRequestBody coupon) async {
    ...
    final _options = _setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://nile-brands-backend.up.railway.app/api/v1//coupons',
  ...
  Future<void> deletCoupon(String id) async {
    ...
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://nile-brands-backend.up.railway.app/api/v1//coupons/{id}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
