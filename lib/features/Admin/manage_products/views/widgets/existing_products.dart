        ...
        children: [
          InkWell(
            ...
            SizedBox(
              ...
              child: Center(child: const Icon(Icons.image_not_supported))): 
              product.coverImage!.contains("https") ? Image.network(
              product.coverImage!,
              width: 159.w,
              height: 120.w,
              fit: BoxFit.fill,
            ) :Image.network("https://nile-brands.up.railway.app/products/${product.coverImage!}") 
          ),
          Padding(
