    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: BlocProvider<SystemUsersCubit>(
          create: (context) => SystemUsersCubit(SystemUsersRepo(systemUsersSource: SystemUsersSource(DioFactory.getDio()))),
          child: Padding(
                ...
                return SingleChildScrollView(
                  child: Column(
                    children: [
                      20.vs,
                      GestureDetector(
                        onTap: () => pickImage(context.read<SystemUsersCubit>()),
                        child: CircleAvatar(
                          radius: 50,
                          backgroundImage: context.read<SystemUsersCubit>().selectedImage != null
                              ? FileImage(context.read<SystemUsersCubit>().selectedImage!)
                      ...
                      SizedBox(
                        ...
                        width: 340.w,
                        child: AppTextFormField(
                          controller: context.read<SystemUsersCubit>().emailController,
                          labelText: "Email",
                      ...
                      SizedBox(
                        ...
                        width: 340.w,
                        child: AppTextFormField(
                          controller: context.read<SystemUsersCubit>().roleController,
                          labelText: "Role",
                      ...
                      SizedBox(
                        ...
                        child: PasswordField(
                          viewPass: viewPass,
                          controller: context.read<SystemUsersCubit>().passwordController,
                          labelText: "Password",
                          hintText: "password",
                        ),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: PasswordField(
                          viewPass: conmfPass,
                          controller: context.read<SystemUsersCubit>().confirmPasswordController,
                      ...
                      if (state is SystemUsersLoading)
                        ...
                        SizedBox(
                          ...
                          child: AppTextButton(
                            ...
                            text: "Save",
                            onPressed: () async{
                             await context.read<SystemUsersCubit>()
                                  .createSystemUser(); 
                            },
                          ),
                        )
