...
class GoogleSigninState with _$GoogleSigninState {
  ...
  const factory GoogleSigninState.googleSuccess({required User user}) = GoogleSuccess;
  const factory GoogleSigninState.googleError({required String error}) = GoogleError;
}
