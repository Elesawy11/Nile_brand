...
class UpdatePasswordState with _$UpdatePasswordState {
  ...
  const factory UpdatePasswordState.updatePasswordLoading() =
      UpdatePasswordLoading;
  const factory UpdatePasswordState.updatePasswordSuccess(
      {required LoginResponse response}) = UpdatePasswordSuccess;
  const factory UpdatePasswordState.updatePasswordError(
      {required String error}) = UpdatePasswordError;
}
