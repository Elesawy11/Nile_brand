...
class CustomTabBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final productCubit = context.read<GetCategoryProductsCubit>()
      ..getCategoryProducts(id: cubit.categoryList[0].id!);
    return TabBar(
      isScrollable: true,
      ...
      onTap: (value) {
        ...
        productCubit.getCategoryProducts(id: cubit.categoryList[value].id!);
      },
      dividerHeight: 0,
