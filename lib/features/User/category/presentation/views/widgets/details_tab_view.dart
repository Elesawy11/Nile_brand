...
class DetailsTabView extends StatefulWidget {
  ...
  const DetailsTabView({super.key, required this.tabController});
  ...
  labelPadding: EdgeInsets.zero, 
      ...
      Tab(
        child: Container(
          ...
          decoration: BoxDecoration(
              border:widget.tabController.index==0? Border.all(color : ColorManager.mainColor):null,
      ...
      Tab(
        child: Container(
          ...
          width: 176.w,
          decoration: BoxDecoration(
              border:widget.tabController.index ==1? Border.all(color : ColorManager.mainColor):null,
              color: ColorManager.grayD9,
              borderRadius: BorderRadius.circular(6.r)),
          child: Center(
            child: Text(
