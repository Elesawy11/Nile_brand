...
class DescreptionInfo extends StatelessWidget {
  const DescreptionInfo({super.key});
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Image.asset(Assets.imagesCartIcon,color: ColorManager.mainColor,width: 24.w,height: 24.h,),),
                    ),
                  ...
                  InkWell(
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Buy Now",style: Styles.font20W700.copyWith(fontSize: 21,color: Colors.white),),
                      ),
                    ),
                  )
                ],
