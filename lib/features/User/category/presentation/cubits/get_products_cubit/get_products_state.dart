...
class GetProductsState with _$GetProductsState {
  ...
  const factory GetProductsState.getProductSuccess(
      {required List<ProductModel> products}) = GetProductSuccess;
  const factory GetProductsState.getProductLoading() = GetProductLoading;
  const factory GetProductsState.getProductError({required String error}) =
      GetProductError;
}
